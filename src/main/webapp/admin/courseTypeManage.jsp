...
<script type="text/javascript">
	...
	function deleteCourseType(){
		...
		if(selectedRows.length==0){
		 ...
		 $.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
				if(r){
					$.post("${pageContext.request.contextPath}/admin/courseType/delete",{ids:ids},function(result){
						if(result.success){
							if(result.exist){
	...
	function openCourseTypeAddDialog(){
		$("#dlg").dialog("open").dialog("setTitle","添加课程类别信息");
		url="${pageContext.request.contextPath}/admin/courseType/save";
	}
	...
	function openCourseTypeModifyDialog(){
		var selectedRows=$("#dg").datagrid("getSelections");
		 ...
		 $("#dlg").dialog("open").dialog("setTitle","编辑课程类别信息");
		 $("#fm").form("load",row);
		 url="${pageContext.request.contextPath}/admin/courseType/save?id="+row.id;
	 }
...
<table id="dg" title="课程类别管理" class="easyui-datagrid"
   fitColumns="true" pagination="true" rownumbers="true"
   url="${pageContext.request.contextPath}/admin/courseType/list" fit="true" toolbar="#tb">
   <thead>
   	<tr>
   		<th field="cb" checkbox="true" align="center"></th>
   		<th field="id" width="20" align="center">编号</th>
   		<th field="typeName" width="100" align="center">课程名称</th>
   		<th field="releaseDate" width="100" align="center">添加时间</th>
   	</tr>
   </thead>
 </table>
 <div id="tb">
