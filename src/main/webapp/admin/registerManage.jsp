...
<script type="text/javascript">
	...
	function deleteCourseType(){
		...
		if(selectedRows.length==0){
		 ...
		 $.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
				if(r){
					$.post("${pageContext.request.contextPath}/admin/stu/delete",{ids:ids},function(result){
						if(result.success){
							if(result.exist){
	...
	function openCourseTypeModifyDialog(){
		var selectedRows=$("#dg").datagrid("getSelections");
		 ...
		 $("#fm").form("load",row);
		 url="${pageContext.request.contextPath}/admin/stu/save?id="+row.id;
	 }
...
<table id="dg" title="登记用户管理" class="easyui-datagrid"
   fitColumns="true" pagination="true" rownumbers="true"
   url="${pageContext.request.contextPath}/admin/stu/list" fit="true" toolbar="#tb">
   <thead>
   	<tr>
   		...
   		<th field="classname" width="100" align="center">班级</th>
   		<th field="freetime" width="100" align="center">上课时间</th>
   		<th field="coursename" width="100" align="center">选择课程</th>
        <th field="parname" width="100" align="center">家长名字</th>
 ...
 <div id="dlg" class="easyui-dialog" style="width:500px;height:180px;padding: 10px 20px"
   ...
   <form id="fm" method="post">
   	<table cellspacing="8px">
   		<tr>
   			<td>家长名字：</td>
   			<td><input type="text" id="typeName" name="parname" class="easyui-validatebox" required="true"/></td>
   		</tr>
   		<tr>
           			<td>孩子名字：</td>
           		...
           		<tr>
                   		...
                   		<tr>
                           		...
                           		<tr>
                                   		...
                                   		<tr>
                                           			<td>时间：</td>
                                           			<td><input type="text" id="freetime" name="freetime" class="easyui-validatebox" required="true"/></td>
                                           		</tr>
                                           		<tr>
                                                   			<td>课程：</td>
                                                   			<td><input type="text" id="coursename" name="coursename" class="easyui-validatebox" required="true"/></td>
                                                   		</tr>
                                                   		<tr>
                                                           			<td>联系方式：</td>
