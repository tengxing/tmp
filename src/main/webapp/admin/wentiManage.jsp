...
<script type="text/javascript">
	...
	function deleteCourseType(){
		...
		if(selectedRows.length==0){
		 ...
		 $.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
				if(r){
					$.post("${pageContext.request.contextPath}/admin/gonggao/delete",{ids:ids},function(result){
						if(result.success){
							if(result.exist){
	...
	function openCourseTypeAddDialog(){
		...
		url="${pageContext.request.contextPath}/admin/gonggao/save";
	}
	...
	function openCourseTypeModifyDialog(){
		var selectedRows=$("#dg").datagrid("getSelections");
		 ...
		 $("#fm").form("load",row);
		 url="${pageContext.request.contextPath}/admin/gonggao/save?id="+row.id;
	 }
...
<table id="dg" title="公告管理" class="easyui-datagrid"
   ...
   url="${pageContext.request.contextPath}/admin/gonggao/list" fit="true" toolbar="#tb">
   <thead>
   	<tr>
   		...
   		<th field="time" width="100" align="center">公告时间</th>
 ...
 <div id="dlg" class="easyui-dialog" style="width:500px;height:180px;padding: 10px 20px"
   ...
   <form id="fm" method="post" enctype="multipart/form-data">
   	<table cellspacing="8px">
   		...
   		<tr>
           			<td>内容：</td>
           			<td><input type="text" id="content" name="content" class="easyui-validatebox" required="true"/></td>
           		</tr>
           		<tr>
                           			<td>图片：</td>
                           			<td><input type="file" id="file" name="file" class="easyui-validatebox" required="true"/></td>
                           		</tr>
