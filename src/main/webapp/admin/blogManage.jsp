...
<script type="text/javascript">
	...
	function openBlogModifyTab(){
		 ...
		 window.parent.openTab('修改新闻','modifyBlog.jsp?id='+row.id,'icon-writeblog');
	}
...
<table id="dg" title="新闻管理" class="easyui-datagrid"
   ...
   url="${pageContext.request.contextPath}/admin/new/list" fit="true" toolbar="#tb">
   <thead>
   	<tr>
   		<th field="cb" checkbox="true" align="center"></th>
   		<th field="id" width="20" align="center">编号</th>
   		<th field="title" width="50" align="center">标题</th>
   		<th field="type" width="50" align="center" >新闻类别</th>
 ...
 <div id="tb">
 	...
 	<div>
 		&nbsp;新闻标题：&nbsp;<input type="text" id="s_title" size="20" onkeydown="if(event.keyCode==13) searchBlog()"/>
