...
<script type="text/javascript">
	...
	function submitData(){
		...
		if(title==null || title==''){
			...
			$.ajax({
			    url: "${pageContext.request.contextPath}/admin/teacher/save",
			    data: formData,
			    type:"post",
			    contentType:false,
			    processData:false,
...
<div id="p" class="easyui-panel" title="添加师资队伍" style="padding: 10px">
 ...
 <script type="text/javascript">
    ...
    var ue = UE.getEditor('editor');
     ...
     ue.addListener("ready",function(){
                    //通过ajax请求数据
                    UE.ajax.request("${pageContext.request.contextPath}/admin/teacher/findById",
                        {
                            method:"post",
                            async : false,
                            data:{"id":"${param.id}"},
